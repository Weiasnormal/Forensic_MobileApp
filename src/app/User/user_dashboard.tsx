...
export default function UserDashboardScreen() {
  ...
  const startNewSignatureDraft = useCaseStore(
    (state) => state.startNewSignatureDraft,
  );
    ...
    <>
      ...
      >
        ...
        <View style={styles.analysisBannerCopy}>
          <Text allowFontScaling={false} style={styles.analysisBannerLabel}>
            START ANALYSIS
          </Text>
          <Text allowFontScaling={false} style={styles.analysisBannerTitle}>
            Signature
          </Text>
        </View>
        ...
        <View style={styles.analysisBannerChevron}>
          <Text
            allowFontScaling={false}
            style={styles.analysisBannerChevronText}
          >
            ›
          </Text>
        </View>
